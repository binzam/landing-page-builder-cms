...
const FeatureCard = ({ item }: { item: FeatureItem }) => {
  return (
    <div className=" bg-neutral-light/30 dark:bg-neutral-light/5 p-4 sm:p-6 rounded-lg shadow-sm shadow-neutral-dark/50 dark:shadow-neutral-light/50">
      <div className="size-14 flex items-center justify-center rounded-full bg-primary-light dark:bg-primary-dark  mb-6 shadow-xs  dark:shadow-neutral-light shadow-neutral-dark ">
        {item.icon && (
          <Image
      ...
      <p className="max-w-lg text-neutral dark:text-neutral-light/70 text-sm/4 sm:text-base/5 font-normal">
        {item.description}
      </p>
    </div>
  );
